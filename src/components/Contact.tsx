...
export default function Contact() {
  return (
    <section id="contact" className="achievements">
      <div className="container">
        <h2 className="section-title">Let's Connect</h2>
        <div className="contact-methods">
          <a href="mailto:mujahidulislamadib@gmail.com" className="contact-card">
            ...
            <div className="contact-info">
              <h3>Email</h3>
              <p>mujahidulislamadib@gmail.com</p>
            </div>
          </a>
          <a href="https://github.com/jonadib" target="_blank" rel="noreferrer" className="contact-card">
            <div className="contact-icon">
            ...
            <div className="contact-info">
              <h3>GitHub</h3>
              <p>github.com/jonadib</p>
            </div>
          </a>
          <a href="https://www.linkedin.com/in/md-mujahidul-islam-adib-017b42287/" target="_blank" rel="noreferrer" className="contact-card">
            <div className="contact-icon">
              <svg width="24" height="24" viewBox="0 0 24 24" fill="currentColor">
