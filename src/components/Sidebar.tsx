  ...
  return (
    <aside className="sidebar">
      <div className="sidebar-content">
        <a href="https://github.com/jonadib" target="_blank" rel="noreferrer" className="social-icon" title="GitHub">
        ...
        <a href="https://www.linkedin.com/in/md-mujahidul-islam-adib-017b42287/" target="_blank" rel="noreferrer" className="social-icon" title="LinkedIn">
          <svg width="20" height="20" viewBox="0 0 24 24" fill="currentColor">
        ...
        <a href="mailto:mujahidulislamadib@gmail.com" className="social-icon" title="Email">
